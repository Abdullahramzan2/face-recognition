...
video_capture = cv2.VideoCapture(0)  # 0,1,2 Change according to the system camera
...
name = None  # Initialize name variable outside the loop
...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        if name in known_face_names:
            ...
            thickness = 3
            lineType = 2
            cv2.putText(frame, name + " Present", bottomLeftCornerOfText, font, fontScale, fontColor, lineType, thickness)
